# PLEASE INPUT PATHS TO THE SPECIFIED LIBRARIES BELOW
...
# path to the directory with binaries of Boost library
...
# path to include directory of cpp-netlib library (http://cpp-netlib.org)
# e.g. CPPNET_SRC=~/cpp-netlib-0.10.1/build/libs/network/src
export CPPNET_SRC=FILL_HERE

# path to the directory with binaries of cpp-netlib library
